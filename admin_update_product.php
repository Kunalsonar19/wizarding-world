...
<head>
   ...
   <title>Update Products : Wizarding World</title>
      ...
      ?>
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <select name="category" class="box" required>
                  ...
                  <option value="Trunk Station">Trunk Station</option>
                  <option value="Clothing">Clothing</option>
                  <option value="Sweet Trolly">Sweet Trolly</option>
               </select>
               <textarea name="details" required placeholder="enter product details" class="box no-br" cols="30" rows="10"><?= $fetch_products['details']; ?></textarea>
