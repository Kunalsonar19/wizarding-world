...
<body>
   ...
   <section class="about" id="scroll">
      ...
      <div class="row">
         ...
         <div class="box">
            <svg width="300px" id="wizarding_world_logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 899.88 673.44" aria-labelledby="wizarding_world_logo_title_header">
               <title id="wizarding_world_logo_title_header">Wizarding World Logo</title>
               <defs>
                  <style>
                     .cls-1 {
                        fill: #10141b;
   ...
   <section class="reviews">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <p>I absolutely love this Harry Potter collection website! The selection of items is fantastic, and the prices are very reasonable. Shipping was also super fast and the customer service team was very responsive to my questions.</p>
            <div class="stars">
         ...
         <div class="box">
            ...
            <p>I had a great experience shopping on this Harry Potter website. The checkout process was smooth and easy, and the product arrived on time and in perfect condition. I will definitely be ordering from here again!.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="box">
            ...
            <p>I'm a huge Harry Potter fan and this website is my go-to for all things related to the wizarding world. The collection is extensive and always up-to-date with the latest merchandise. Plus, the website is user-friendly and easy to navigate.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="box">
            ...
            <p>LWhile I enjoyed the products on this Harry Potter website, the customer service could use some improvement. I had a few issues with my order, but it took a while to get a response from the support team.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="box">
            ...
            <p>I recently ordered some Harry Potter merchandise from this website, and I have to say I'm thoroughly impressed! The selection of products is amazing - they have everything from Hogwarts robes to wands to collectible figurines.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="box">
            ...
            <p>I cannot express enough how much I love this Harry Potter collection website! As a die-hard fan of the wizarding world, I was thrilled to find such a vast selection of merchandise all in one place. From clothing to home decor to collectibles.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
