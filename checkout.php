...
<head>
   ...
   <title>Checkout : Wizarding World</title>
   ...
   <section class="checkout-orders">
      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               <span>Landmark :</span>
               <input type="text" name="street" placeholder="e.g. Near Post Office" class="box">
            </div>
            <div class="inputBox">
               <span>city :</span>
            ...
            <div class="inputBox">
               <span>pin code :</span>
               <input type="number" min="0" name="pin_code" placeholder="e.g. 400 - 104" class="box" required>
            </div>
         </div>
         <br><br><br><br>
